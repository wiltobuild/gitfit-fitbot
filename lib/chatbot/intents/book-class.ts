  ...
  match: (message) =>
    !timeOffShaped.test(message)
      ? scoreTriggerFamily(message, [
        ...
        (1 +
          scoreEntity(message, [
            /\b(yoga|cycling|hiit|boxing|pilates|strength|today|tomorrow|tonight|sunday|monday|tuesday|wednesday|thursday|friday|saturday|sofia|martinez|marcus|lee|avery|thompson|diego|reyes|elena|cruz|jordan|blake)\b/i
          ]))
      : 0,
