  ...
  return <div className="staff-console">
    ...
    <main>
      ...
      <div className="staff-console-content">
        {isManager ? <>
          <StudioPulse stats={pulseStats} teachingLoad={teachingLoad} />
          ...
          <RequestsInbox initialRequests={pendingRequests} />
          <div className="staff-lower-grid"><AtRiskMembers members={atRiskMembers} totalCount={atRiskMembersTotal} /><ActivityLog entries={activityEntries} /></div>
        </> : <MyRequests requests={myRequests} />}
        <div className="staff-lower-grid"><MemberSearch /><StaffFitBotTiles /></div>
      </div>
    </main>
  </div>;
}
